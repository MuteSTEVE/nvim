...
function PLUG.config()
  ...
  map('n', "<A-h>", function() vim.lsp.buf.hover() end, {})
  map('n', "<A-f>", function() vim.diagnostic.open_float() end, {})
  ...
  map('n', "<S-r>", function() vim.lsp.buf.rename() end, {})
  map('i', "<A-h>", function() vim.lsp.buf.signature_help() end, {})
end
